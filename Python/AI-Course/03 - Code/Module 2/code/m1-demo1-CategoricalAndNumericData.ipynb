   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "0     0.994557       0.574138       1.049901                   False   \n",
       "1    -0.646391      -0.169564      -0.178476                   False   \n",
       "2     1.493976       0.053547       0.544099                   False   \n",
       "3     0.209756       0.797248       0.688613                    True   \n",
       "4    -1.145810       0.053547      -0.395248                   False   \n",
       "..         ...            ...            ...                     ...   \n",
       "95   -0.432354       0.648508       0.977643                    True   \n",
       "96   -0.361008      -0.392675      -0.395248                   False   \n",
       "97    0.281101       1.094729       1.194416                   False   \n",
       "98    1.708013       1.169099       0.905386                   False   \n",
       "99   -0.004281       1.540950       1.555703                    True   \n",
       "\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "0       1    0.994557       0.574138       1.049901                   False   \n",
       "1       0   -0.646391      -0.169564      -0.178476                   False   \n",
       "2       1    1.493976       0.053547       0.544099                   False   \n",
       "3       0    0.209756       0.797248       0.688613                    True   \n",
       "4       0   -1.145810       0.053547      -0.395248                   False   \n",
       "\n",
       "   race/ethnicity_group B  race/ethnicity_group C  race/ethnicity_group D  \\\n",
       "0                   False                   False                   False   \n",
       "1                   False                    True                   False   \n",
